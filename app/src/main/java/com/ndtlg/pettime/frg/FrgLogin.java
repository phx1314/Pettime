...
import com.ndtlg.pettime.bean.BeanLogin;
import com.ndtlg.pettime.bean.BeanLogin3;
import com.ndtlg.pettime.bean.BeanMGetMobileMsg;
import com.ndtlg.pettime.bean.BeanMRegist;
import com.ndtlg.pettime.model.ModelLogin;
import com.ndtlg.pettime.model.ModelLogin3;
import com.ndtlg.pettime.model.ModelQQ;
import com.ndtlg.pettime.model.ModelWx;
...
import static com.ndtlg.pettime.F.MGetMobileMsg;
import static com.ndtlg.pettime.F.MLogin;
import static com.ndtlg.pettime.F.MLoginWeixinQQ;
import static com.ndtlg.pettime.F.MRegist;
import static com.ndtlg.pettime.F.json2Model;
import static com.ndtlg.pettime.F.uid;
import static com.ndtlg.pettime.F.verify;
import static com.ndtlg.pettime.F.wxqqid;
...
public class FrgLogin extends BaseFrg {
    ...
    public void onSuccess(String methodName, String content) {
        if (methodName.equals(MGetMobileMsg)) {
            ...
            com.ndtlg.pettime.F.saveJson("uid", uid);
            com.ndtlg.pettime.F.saveJson("verify", verify);
            ...
            com.ndtlg.pettime.F.saveJson("uid", uid);
            com.ndtlg.pettime.F.saveJson("verify", verify);
            com.ndtlg.pettime.F.saveJson("wxqqid", wxqqid);
